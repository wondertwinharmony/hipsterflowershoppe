...
export default class Home extends Component {
  render() {
    ...
    <div id="home-content">
      ...
      <a className="smartBalloonLink" href="http://www.theballooncouncil.org/smart-balloon-practices/" target="_blank"><img className="smartBalloonImg" src="https://dk-media.s3.amazonaws.com/media/1k8es/images/17044902/huge/SmartBalloonIconWeb1.jpg" alt="SmartBalloonIconWeb1.jpg"/></a>
      <ul>
